...
/*!
  * @intlify/message-resolver v9.0.0-beta.16
  * (c) 2020 kazuya kawaguchi
  * Released under the MIT License.
  */
const isObject$2 = (val) => // eslint-disable-line
 val !== null && typeof val === 'object';
...
function parseTranslateArgs(...args) {
    ...
    const options = {};
    if (!isString$1(arg1) && !isNumber(arg1)) {
...
const _hoisted_1 = { id: "fruits" };
const _hoisted_2 = /*#__PURE__*/createVNode("option", { value: "0" }, "0", -1 /* HOISTED */);
const _hoisted_3 = /*#__PURE__*/createVNode("option", { value: "1" }, "1", -1 /* HOISTED */);
const _hoisted_4 = /*#__PURE__*/createVNode("option", { value: "2" }, "2", -1 /* HOISTED */);
const _hoisted_5 = /*#__PURE__*/createVNode("option", { value: "3" }, "3", -1 /* HOISTED */);

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock(Fragment, null, [
    createVNode("form", _hoisted_1, [
      createVNode("label", null, toDisplayString($setup.t('select')), 1 /* TEXT */),
      withDirectives(createVNode("select", {
        "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ($setup.select = $event))
      }, [
        _hoisted_2,
        _hoisted_3,
        _hoisted_4,
    ...
    createVNode("p", null, toDisplayString($setup.t('fruits.banana', $setup.select, { n: $setup.select })), 1 /* TEXT */)
  ], 64 /* STABLE_FRAGMENT */))
}

script.render = render;
script.__file = "examples/composition/Banana.vue";
...
const _hoisted_1$1 = /*#__PURE__*/createVNode("option", { value: "en" }, "en", -1 /* HOISTED */);
const _hoisted_2$1 = /*#__PURE__*/createVNode("option", { value: "ja" }, "ja", -1 /* HOISTED */);

function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Banana = resolveComponent("Banana");
...
function block0 (Component) {
  ...
  Component.__i18n.push({
    ...
    "resource": {
      ...
      "ja": {
        "language": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["言語"])};fn.source="言語";return fn;})(),
        "hello": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["こんにちは、世界！"])};fn.source="こんにちは、世界！";return fn;})()
      }
    }
  });
}

if (typeof block0 === 'function') block0(script$1);

script$1.render = render$1;
script$1.__file = "examples/composition/App.vue";

var ja = {
  "select": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["バナナが欲しい？"])};fn.source="バナナが欲しい？";return fn;})(),
  "fruits": {
    "banana": (()=>{const fn=(ctx) => {const { normalize: _normalize, interpolate: _interpolate, named: _named, plural: _plural } = ctx;return _plural([_normalize(["バナナがない"]), _normalize(["バナナ ", _interpolate(_named("n")), " 個"])])};fn.source="バナナがない | バナナ {n} 個";return fn;})()
  }
};

var en = {
  "select": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Do you want banana?"])};fn.source="Do you want banana?";return fn;})(),
  "fruits": {
    "banana": (()=>{const fn=(ctx) => {const { normalize: _normalize, interpolate: _interpolate, named: _named, plural: _plural } = ctx;return _plural([_normalize(["no bananas"]), _normalize([_interpolate(_named("n")), " banana"]), _normalize([_interpolate(_named("n")), " bananas"])])};fn.source="no bananas | {n} banana | {n} bananas";return fn;})()
  }
};
...
const app$1 = createApp(script$1);
